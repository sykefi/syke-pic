...
class PredictionViewer:
    ...
    def __init__(
        ...
        if self.select:
            ...
            if self.label and self.moved_log.is_file():
                ...
                print(
                    f"[INFO] Skipped {i} previously labeled images in "
                    f"'{self.moved_log}'"
                )
    ...
    def _show_current_page(self, *args):
        ...
        end_btn = Button(description="End", button_style="warning", tooltip=end_tooltip)
    ...
    def _end_button_handler(self, button):
        ...
        if self.label:
            ...
            back_btn = Button(
                description="Back", button_style="info", tooltip="Back to previous page"
            )
